...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end shadow">
                                {{-- Enlace al Dashboard solo para el Admin (Si tiene el middleware de admin o rol) --}}
                    ...
                    {{-- SELECTOR DE IDIOMA --}}
                    <li class="nav-item dropdown ms-lg-4 mt-2 mt-lg-0">
    ...
    <footer class="copyright py-4 text-center text-white bg-dark mt-auto border-top border-secondary">
        <div class="container">
            <small>Copyright © 2026 - <span class="fw-bold">Tu Nombre Aquí</span></small>
        </div>
    </footer>
